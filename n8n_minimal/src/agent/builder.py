...
def create_agentic_graph(workflow: WorkflowGraph) -> StateGraph:
    ...
    model_node = next((n for n in workflow.nodes if n.type.lower() == "model"), None)
    ...
    model_name = model_node.config.get("model_name", "llama3-8b-8192")
    ...
    for tool_node in tool_nodes:
        tool_name = tool_node.config.get("tool_name")
